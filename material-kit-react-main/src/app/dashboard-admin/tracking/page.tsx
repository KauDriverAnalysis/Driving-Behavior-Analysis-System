...
export default function Tracking(): React.JSX.Element {
  ...
  const fetchCars = () => {
    ...
    const url = companyId
      ? `https://driving-behavior-analysis-system.onrender.com/api/get-car-location/?userType=company&userId=${companyId}`
      : 'https://driving-behavior-analysis-system.onrender.com/api/get-car-location/';
